...
from .modules.infrastructure.process_video_rfdetr import ProcessVideo as ProcessVideoRfDetr
...
#
# Video upload API view (RfDetr)
#
class RfDetrAPIView(APIView):
    authentication_classes = []
    permission_classes = []
